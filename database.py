...
def resolve_api_key(secrets):
    ...
    read_only_key = secrets.get("MONGO_API_KEY") or os.environ.get("MONGO_API_KEY")
    ...
    return valid_key, read_only_key
...
VALID_API_KEY, READ_ONLY_API_KEY = resolve_api_key(VAULT_SECRETS)
